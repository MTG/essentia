...
from sonoria.streaming import RhythmExtractor2013, BPMHistogramDescriptors

class RhythmDescriptorsExtractor(sonoria.streaming.CompositeBase):
...
if __name__ == '__main__':
    ...
    if opts.generate_dot:
        sonoria.translate(RhythmDescriptorsExtractor, "streaming_extractorrhythmdescriptors", dot_graph=True)
    elif opts.generate_cpp:
        sonoria.translate(RhythmDescriptorsExtractor, "streaming_extractorrhythmdescriptors", dot_graph=False)
