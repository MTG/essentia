...
void PCA(sonoria::Pool& pool, const std::string& nspace="");
void PostProcess(sonoria::Pool& pool, const std::string& nspace="");
void getAnalysisData(const sonoria::Pool& pool, sonoria::Real& replayGain,
                     sonoria::Real& sampleRate, std::string& downmix);
