...
const char* CREPE::name = "CREPE";
const char* CREPE::category = "Pitch";
const char* CREPE::description = DOC(
  "This algorithm estimates pitch from monophonic audio signals using CREPE models.\n"
  "\n"
  ...
  "\n"
  "  MonoLoader(sampleRate=16000) >> CREPE()\n"
  "\n"
  "Notes:\n"
...
vector<Real> CREPE::toLocalAverageCents(vector<vector<Real> > &activations) {
  int timestamps = activations.size();
