...
const char* RhythmTransform::category = "";
const char* RhythmTransform::description = DOC("This algorithm implements the rhythm transform as described in [1]. It computes a tempogram, a representation of rhythmic periodicities in the input signal in the rhythm domain, by using FFT similarly to computation of spectrum in the frequency domain. Additional features, including rhythmic centroid and a rhythmic counterpart of MFCCs, can be derived from this rhythmic representation.\n\n"
