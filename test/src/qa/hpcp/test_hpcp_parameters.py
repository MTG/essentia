...
test2SignalsMapping = {'testWindowWholeRange': testSignals[0:10],
                            'testFrameSize': testSignals[1:4], 
                            'testMaxFreq': testSignals[8:10],
                            'testJordiNL': [testSignals[0]],
                            'testWeigth': [testSignals[0]],
                            'testLPFilterMeanSpectrum': testSignals[10:10+13],
                            'testBPFilterMeanSpectrum': [testSignals[10]] + list(testSignals[23:23+12]),
                            'testLPFilterFrameSpeaks': testSignals[10:10+13],
                            'testBPFilterFrameSpeaks': [testSignals[10]] + list(testSignals[23:23+12]),
                            'testNormalizeWindow': [testSignals[0]],
                            'testNormalizeHPCP': [testSignals[0]],
                           }
