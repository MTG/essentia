...
class TestBpmHistogramDescriptors(TestCase):
    ...
    def testEmpty(self):
        bpm1, weight1, spread1, bpm2, weight2, spread2, _ = BpmHistogramDescriptors()([])
    ...
    def testZero(self):
        bpm1, weight1, spread1, bpm2, weight2, spread2, _ = BpmHistogramDescriptors()([0])
        self.assertEqual(bpm1, 0)
        self.assertEqual(weight1, 0)
        self.assertEqual(spread1, 0)
        self.assertEqual(bpm2, 0)
    ...
    def testOne(self):
        bpm1, weight1, spread1, bpm2, weight2, spread2, _ = BpmHistogramDescriptors()([0.5])
    ...
    def testAbnormalValues(self):
        ...
        bpm1, weight1, spread1, bpm2, weight2, spread2, _ = BpmHistogramDescriptors()(intervals)
        self.assertEqual(bpm1, 0)
        self.assertEqual(weight1, 0)
        self.assertEqual(spread1, 0)
        self.assertEqual(bpm2, 0)
    ...
    def testRounding(self):
        bpm1, weight1, spread1, bpm2, weight2, spread2, _ = BpmHistogramDescriptors()([60. / 100.5])
