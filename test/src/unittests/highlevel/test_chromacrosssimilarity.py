...
from sonoria import run as ess_run
...
class TestChromaCrossSimilarity(TestCase):
    ...
    # hpcp matrix of a short query song segment (2 frames) computed using sonoria hpcp algorithm
    ...
    # hpcp matrix of a short reference song segment (3 frames) computed using sonoria hpcp algorithm
